...
import { VideoType, VideoGenre } from '../types/video-script.types';
...
export const NARRATIVE_ARCS: Record<VideoType, NarrativeArc> = {
    ...
    tutorial: {
        ...
        storytellingPrinciple: 'Every scene teaches exactly ONE concept or action. The viewer must feel capable, not overwhelmed.',
    ...
    story: {
        ...
        description: 'A narrative arc that builds emotional investment through character journey and meaningful resolution.',
        storytellingPrinciple: 'Every great story needs a character who wants something, faces obstacles, and is changed by the journey.',
        hookStrategy: 'Start in the middle of a tension point — drop the viewer into a moment of suspense or curiosity.',
        closingStrategy: 'End with a universal truth or emotional resonance that makes the story feel personally meaningful.',
        scenes: [
            {
    ...
    listicle: {
        ...
        scenes: [
            ...
            },
            {
                ...
                techniques: ['Frame as exclusive knowledge: "This last one is the game-changer"', 'Include a memorable phrase or visual metaphor'],
    ...
    news: {
        ...
        description: 'An inverted-pyramid news arc that leads with the most important information and adds context progressively.',
        storytellingPrinciple: 'Answer "Who, What, When, Where, Why" as early as possible. Context is not optional — it is the value.',
    ...
    animation: {
        ...
        storytellingPrinciple: 'Motion IS the message. Each scene should feel like a frame from a dynamic film — not a static diagram.',
        ...
        scenes: [
            {
                ...
                techniques: ['Start with a large-scale visual metaphor', 'Use scale contrast (tiny character vs enormous world)'],
    ...
    review: {
        ...
        storytellingPrinciple: 'Credibility comes from showing both strengths and weaknesses. The viewer trusts a reviewer who challenges what they review.',
        ...
        scenes: [
            {
                ...
                techniques: ['Lead with opinion: "This is the best/worst X I\'ve tried"', 'Pose the central question the review answers'],
    ...
    motivational: {
        ...
        storytellingPrinciple: 'Connect to the viewer\'s pain before offering the solution. People don\'t take action from advice — they act from emotion.',
        ...
        scenes: [
            {
                ...
                techniques: ['Use second person: "You\'ve been told...", "Most people feel..."', 'Name the specific emotion (stuck, overwhelmed, doubting)'],
            ...
            },
            {
                ...
                techniques: ['Reframe the problem as a system or belief, not a personal failure', 'Use a visual metaphor for the root cause'],
            ...
            },
            {
                ...
                techniques: ['Make it micro: "This week, just do X for 5 minutes"', 'Show the first step only — reduce overwhelm'],
    ...
    entertainment: {
        ...
        description: 'A high-energy arc that hooks through personality, builds through escalation, and rewards with a memorable payoff.',
        storytellingPrinciple: 'The rhythm of entertainment is: setup → build → release. Reward the viewer\'s attention with a satisfying punchline or spectacle.',
        ...
        scenes: [
            {
                ...
                purpose: 'The viewer has 1 second before they scroll. Open with the most ridiculous, funny, or wild thing first.',
            ...
            },
            {
                ...
                techniques: ['Callback to opening for satisfying circularity', 'End with an unresolved absurdity or perfect punchline'],
    ...
    faceless: {
        ...
        description: 'A narration-first arc where the visuals amplify the voiceover without relying on a visible presenter.',
        storytellingPrinciple: 'The narration carries the story. Visuals must illustrate the words metaphorically — show the concept, not just the speaker.',
        hookStrategy: 'Open with a question or statement so intriguing the viewer must hear the answer.',
        closingStrategy: 'End with a reveal or conclusion that reframes everything said before — a "now you see it" moment.',
        scenes: [
            {
                role: 'intrigue_hook',
                label: 'Hook — Intriguing Question or Statement',
                purpose: 'Pose a question, fact, or statement that is impossible to ignore.',
                techniques: ['Use counterintuitive fact: "Most people believe X but actually..."', '"What if I told you..." or direct curiosity gap'],
            ...
            },
            {
                ...
                techniques: ['Make it specific: not "success" but "why do 95% fail at X"', 'Use statistics or surprising scale'],
            ...
            },
            {
                ...
                techniques: ['Partial reveal: "It comes down to one thing..."', 'Create curiosity gap: establish what they will learn'],
...
export const GENRE_STORYTELLING: Record<VideoGenre, GenreStorytelling> = {
    ...
    business: {
        ...
        narrativeStyle: 'Frame every insight in terms of outcomes: time saved, revenue increased, risk reduced, or competitive advantage gained.',
    ...
    finance: {
        ...
        narrativeStyle: 'Numbers tell the story. Use concrete figures, percentages, and timelines to make abstract concepts tangible.',
        audienceExpectation: 'Viewers want financial clarity and confidence. They\'re often anxious about money and need reassurance alongside information.',
        pacing: 'medium',
        emotionalRegister: 'Anxiety about money → clarity → empowerment to act',
        languageStyle: 'Simple language for complex concepts. Define financial terms. Use relatable amounts ($100, not $1M).',
        mustInclude: [
    ...
    health: {
        ...
        narrativeStyle: 'Connect health information to how the viewer will FEEL, not just what they should do. Physical benefits must be made emotionally tangible.',
        audienceExpectation: 'Viewers want practical, believable health information that fits their real life. They\'re skeptical of miracle claims.',
        pacing: 'medium',
        emotionalRegister: 'Awareness of problem/desire → understanding → motivation to change',
        languageStyle: 'Accessible scientific language. Avoid both medical jargon and pseudoscience. Use research references naturally.',
        mustInclude: [
    ...
    travel: {
        ...
        narrativeStyle: 'Transport the viewer there before teaching them anything. Sensory details — sight, sound, taste — come before facts.',
    ...
    food: {
        ...
        narrativeStyle: 'Food content must make the viewer hungry. Descriptions should be visceral — color, texture, smell, sound.',
        audienceExpectation: 'Viewers want to be inspired to cook, eat, or discover something new. They value authenticity and passion.',
        pacing: 'dynamic',
    ...
    gaming: {
        ...
        narrativeStyle: 'Gaming content respects the viewer\'s knowledge. Lead with strategy and insight, not explanations of basic concepts.',
        audienceExpectation: 'Viewers are passionate and knowledgeable. They want to improve, discover, or be entertained by someone who understands the game.',
        pacing: 'fast',
    ...
    sports: {
        ...
        narrativeStyle: 'Sports content lives in the moment. Ground every analysis in a specific game, player, or moment — then zoom out.',
    ...
    science: {
        ...
        narrativeStyle: 'Start with the wonder — the counterintuitive fact or mind-bending question — then build the explanation that makes it make sense.',
        audienceExpectation: 'Viewers want to feel smarter and more amazed by the world. They value accuracy but also want to be blown away.',
        pacing: 'medium',
    ...
    history: {
        ...
        narrativeStyle: 'Tell history as story — with characters, motivations, and consequences. Facts gain meaning through narrative context.',
        ...
        languageStyle: 'Vivid narrative prose. Historical specificity (dates, names, places used purposefully). Connect past to present.',
        mustInclude: [
    ...
    'self-improvement': {
        ...
        narrativeStyle: 'Acknowledge the struggle before offering the solution. Viewers trust content that doesn\'t pretend change is easy.',
        audienceExpectation: 'Viewers want real, applicable improvement tools — not motivational fluff. They have high tolerance for directness.',
        pacing: 'medium',
    ...
    mystery: {
        ...
        audienceExpectation: 'Viewers want to be intrigued, then satisfied. The pleasure is in the investigation AND the solution.',
        pacing: 'dynamic',
    ...
    fun: {
        ...
        narrativeStyle: 'Fun content prioritizes the experience over the message. The viewer should smile or laugh first, think second.',
        audienceExpectation: 'Viewers want entertainment value. They measure success by how much they enjoyed it, not what they learned.',
        pacing: 'fast',
    ...
    general: {
        ...
        audienceExpectation: 'Viewers expect professional, well-structured content with clear value. No specific expertise required.',
        pacing: 'medium',
...
export function scaleNarrativeArc(arc: NarrativeArc, targetCount: number): NarrativeSceneRole[] {
    ...
    const selectedRoles = new Set([
        ...required.map(s => s.role),
        ...selectedOptional.map(s => s.role),
    ]);
...
export function buildNarrativeArcPrompt(
    ...
    lines.push('----------------------------------------------------------------');
    lines.push(`NARRATIVE ARC — ${arc.name.toUpperCase()}`);
    lines.push('----------------------------------------------------------------');
    lines.push(`Storytelling Principle: ${arc.storytellingPrinciple}`);
    lines.push(`Hook Strategy: ${arc.hookStrategy}`);
    lines.push(`Closing Strategy: ${arc.closingStrategy}`);
    lines.push('');
    lines.push(`MANDATORY SCENE STRUCTURE (${sceneCount} scenes):`);
    lines.push('Each scene MUST fulfill its designated narrative role below:');
    lines.push('');

    scaledScenes.forEach((scene, index) => {
        lines.push(`Scene ${index + 1} — ${scene.label}`);
        lines.push(`  Purpose: ${scene.purpose}`);
        lines.push(`  Techniques: ${scene.techniques.join(' | ')}`);
        lines.push(`  Visual Guidance: ${scene.visualGuidance}`);
        lines.push('');
    });

    if (genre) {
        lines.push('----------------------------------------------------------------');
        lines.push(`GENRE GUIDELINES — ${genre.videoGenre.toUpperCase()}`);
        lines.push('----------------------------------------------------------------');
        lines.push(`Tone: ${genre.toneDescription}`);
        lines.push(`Narrative Style: ${genre.narrativeStyle}`);
        lines.push(`Audience Expectation: ${genre.audienceExpectation}`);
        lines.push(`Pacing: ${genre.pacing}`);
        lines.push(`Emotional Journey: ${genre.emotionalRegister}`);
        lines.push(`Language Style: ${genre.languageStyle}`);
        lines.push('');
