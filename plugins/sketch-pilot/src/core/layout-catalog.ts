...
export const LAYOUT_CATALOG: Record<LayoutId, LayoutDefinition> = {
  ...
  'character-center-bottom-text': {
    ...
    useCases: ['intro hook', 'narrator moment', 'single key statement', 'punchline delivery', 'emotional reaction'],
  ...
  'character-left-text-right': {
    ...
    compositionInstruction: 'Character on left, text on right.',
    aiDescription: 'Character left, text right.',
    useCases: ['explaining a concept', 'delivering a result', 'commentary on a fact', 'narrating with emphasis'],
  ...
  'character-right-text-left': {
    ...
    compositionInstruction: 'Text on left, character on right.',
    aiDescription: 'Text left, character right.',
    useCases: ['presenting a list', 'slide-like format', 'topic introduction', 'character reacting to text'],
  ...
  'text-only-center': {
    ...
    compositionInstruction: 'Text only, centered. No character.',
    aiDescription: 'Text only, centered.',
    useCases: ['key statistic', 'powerful quote', 'transition slide', 'big number reveal', 'memorable statement'],
  ...
  'text-columns-multi': {
    ...
    compositionInstruction: 'Multiple text columns. No character.',
  ...
  'checklist-with-character': {
    ...
    compositionInstruction: 'Checklist left, character right.',
    aiDescription: 'Checklist left, character right.',
    useCases: ['showing achievements', 'to-do list recap', 'feature highlights', 'summary of points'],
  ...
  'dual-character-split': {
    ...
    compositionInstruction: 'Two characters side by side.',
  ...
  'dual-character-arrow': {
    ...
    compositionInstruction: 'Character left, arrow, character right. Transformation.',
    aiDescription: 'Character left, arrow, character right.',
    useCases: ['transformation', 'result of an action', 'cause and effect', 'before and after', 'process result'],
  ...
  'multi-character-3col': {
    ...
    useCases: ['3 types of people', '3 steps or stages', 'different options', '3 scenarios'],
    bestForAspectRatio: ['16:9'],
    hasCharacter: true,
    multipleCharacters: true
  },
  ...
  'multi-character-grid-6': {
    ...
    compositionInstruction: '6 characters in 3x2 grid.',
  ...
  'image-grid-3x2': {
    ...
    compositionInstruction: '6 items in 3x2 grid. No character.',
  ...
  'character-thought-bubble': {
    ...
    compositionInstruction: 'Character with thought bubble above.',
    aiDescription: 'Character with thought bubble above.',
    useCases: ['inner monologue', 'confusion or doubt', 'hesitation', 'questioning themselves', 'internal conflict'],
  ...
  'character-pointing-visual': {
    ...
    compositionInstruction: 'Character pointing at chart/visual on opposite side.',
  ...
  'character-icons-around': {
    ...
    compositionInstruction: 'Character with floating icons around.',
  ...
  'character-with-object-side': {
    ...
    compositionInstruction: 'Character beside large object.',
  ...
  'full-frame-action': {
    ...
    compositionInstruction: 'One character fills frame dramatically.',
  ...
  'narrator-besides-ui': {
    ...
    compositionInstruction: 'Character beside large app/UI interface.',
  ...
  'individual-vs-crowd': {
    ...
    compositionInstruction: 'One large character vs small crowd on opposite side.',
  ...
  'triple-action-simultaneous': {
    ...
    compositionInstruction: '3 different actions in 3 vertical zones.',
  ...
  'data-viz-comparison': {
    ...
    compositionInstruction: 'Data/graphics comparisons with percentages and numbers. No large character.',
  ...
  'asymmetric-action-focus': {
    ...
    compositionInstruction: 'All action on extreme left or right. Mostly empty space opposite.',
  ...
  'character-seated-thought-box': {
    ...
    compositionInstruction: 'Character seated on left, large text box on right.',
  ...
  'split-scene-top-bottom': {
    ...
    compositionInstruction: 'Text at top, action scene at bottom.',
  ...
  'character-inside-object': {
    ...
    compositionInstruction: 'Character half-emerged from a large center object.',
  ...
  'visual-metaphor-center': {
    ...
    compositionInstruction: 'Large visual metaphor centered. No character.',
  ...
  'character-peeking-side': {
    ...
    compositionInstruction: 'Character peeking behind text block.',
  ...
  'character-besides-signpost': {
    ...
    compositionInstruction: 'Character beside signpost with arrows.',
  ...
  'three-panel-comic-strip': {
    ...
    compositionInstruction: '3 horizontal comic-style panels with sequential scenes.',
  ...
  'reference-image-center': {
    ...
    compositionInstruction: 'Large reference image/photo centered with text.',
  ...
  'roadmap-winding-path': {
    ...
    compositionInstruction: 'Winding path with milestone markers. Character along path.',
...
): { character?: LayoutZone; text?: LayoutZone } {
...
export function getLayoutsForAspectRatio(aspectRatio: AspectRatio): LayoutId[] {
  return ALL_LAYOUT_IDS.filter((id) => LAYOUT_CATALOG[id].bestForAspectRatio.includes(aspectRatio))
}
