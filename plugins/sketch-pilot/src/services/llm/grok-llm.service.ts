        ...
        return new Promise(async (resolve, reject) => {
            const req = https.request({
                ...
                res.on('end', () => {
                    ...
                    try {
                        console.log(`[GrokLLM] Raw response (first 500 chars): ${body.substring(0, 500)}...`);
                        ...
                        console.error("[GrokLLM] Parsing error:", e, body);
                        reject(e);
                    }
                });
            });
            ...
            req.on('error', async (error) => {
                ...
                if (isNetError && attempt < maxRetries) {
                    ...
                    console.warn(`[GrokLLM] Network error, retrying in ${delay / 1000}s... (attempt ${attempt + 1}/${maxRetries})`);
                    setTimeout(() => {
