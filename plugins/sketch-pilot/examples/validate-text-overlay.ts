...
import { textOverlayConfigSchema, textPositionSchema, type TextPosition } from '../src/types/video-script.types'
...
const validPositions: TextPosition[] = [
  'top',
  'center',
  'bottom',
  'top-left',
...
testTexts.forEach((test, index) => {
  ...
  console.log(`    Input: "${test.text.slice(0, 50)}..."`)
