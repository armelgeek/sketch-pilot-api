...
async function main() {
    ...
    const STYLE_SUFFIX = "Full body visible, tight composition, entire character visible from head to toe, minimalist stickman, vector style, flat design, clean lines, solid off-white background (#F5F5F5), high quality, no text, no borders.";
    ...
    const topic = "Why you are not losing weight on a diet, explained with a stickman character going through different scenarios like eating healthy, exercising, and facing common pitfalls.";
    ...
    console.log(`   - Animation: $${animationCost.toFixed(2)} (${isAIAnimation ? '$0.15/s - Short Loop' : 'FREE - Panning Mode'})`);
