...
async function testKokoroTTS() {
  ...
  const voices = [
    {
      preset: 'af_heart',
      lang: 'en-US',
      text: 'Hello! This is af_heart speaking. Kokoro TTS is ultra-cheap and runs on Hugging Face.'
    },
    {
      preset: 'af_bella',
      lang: 'en-US',
      text: 'Hello! This is af_bella speaking. Kokoro TTS is ultra-cheap and runs on Hugging Face.'
    },
    {
      preset: 'am_adam',
      lang: 'en-US',
      text: 'Hello! This is am_adam speaking. Kokoro TTS is ultra-cheap and runs on Hugging Face.'
    },
    {
      preset: 'bf_emma',
      lang: 'en-US',
      text: 'Hello! This is bf_emma speaking. Kokoro TTS is ultra-cheap and runs on Hugging Face.'
    }
  ]
  ...
  for (const voiceConfig of voices) {
    try {
      ...
      console.error(
        `   ❌ Error with voice ${voiceConfig.preset}:`,
