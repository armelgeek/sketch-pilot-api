...
const videoTypes: VideoType[] = [
    'faceless', 'tutorial', 'listicle', 'news', 'animation', 
    'review', 'story', 'motivational', 'entertainment'
];
...
const videoGenres: VideoGenre[] = [
    'educational', 'fun', 'business', 'lifestyle', 'tech',
    'finance', 'health', 'travel', 'food', 'gaming', 'sports',
    'science', 'history', 'self-improvement', 'mystery', 'general'
];
...
const combinations = [
    ...
    { type: 'motivational' as VideoType, genre: 'self-improvement' as VideoGenre, desc: 'Motivational + Self-improvement' },
];
