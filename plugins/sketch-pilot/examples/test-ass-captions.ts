...
async function runTest() {
    console.log('Testing ASS Caption Service...\\n');
    ...
    console.log('ffmpeg -f lavfi -i color=c=black:s=1080x1920:d=5 -vf "ass=output/test-captions-animated-background.ass" output/test-render.mp4');
}
