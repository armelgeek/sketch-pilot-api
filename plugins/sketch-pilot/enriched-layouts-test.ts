...
async function testEnrichedLayouts() {
  ...
  const systemPrompt =
    'You are a professional SHORT-FORM VIDEO DIRECTOR and SCRIPT WRITER specialized in whiteboard stickman animation.'
  const styleSuffix =
    'whiteboard animation style, hand-drawn sketchy stickman, ink on paper, minimalist off-white background'
  ...
  const topic =
    'The daily life of a remote software developer, from morning coffee to deep focus to evening relaxation.'
